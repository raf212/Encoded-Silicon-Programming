...
private:
    ...
    {
        if (PCMode_ == PackedMode::MODE_48_ATOMIC_GUARANTEED)
        {
...
public:
    AtomicAdaptiveBackoff() noexcept :
        AtomicAdaptiveBackoff(PCBCfg(), PackedMode::MODE_32_ATOMIC_GUARANTEED, nullptr)
    {}
    explicit AtomicAdaptiveBackoff
                (
                    const PCBCfg& cfg,
                    PackedMode mode = PackedMode::MODE_32_ATOMIC_GUARANTEED,
