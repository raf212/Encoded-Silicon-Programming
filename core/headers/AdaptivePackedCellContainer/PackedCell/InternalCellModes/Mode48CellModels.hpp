...
namespace PredictedAdaptedEncoding
{
    ...
    struct Subdevision16x3InternalMode48CellModel
    {
        ...
        {
            return PackedCell64_t::ExtractModeOfPackedCellFromPacked(packed_cell) == PackedMode::MODE_48 &&
    ...
    struct Subdivision2x16Plus2x8InternalMode48CellModel
    {
        ...
        ) noexcept
        {
            ...
            const packed64_t compressed_packed_cell = PackedCell64_t::ComposeCLK48u_64(raw48, meta16);
        ...
        static bool IsThisCellAFourSubdevision_48t(packed64_t packed_cell) noexcept
        {
            ...
            return this_cell_auth_view.CellMode == PackedMode::MODE_48 &&
