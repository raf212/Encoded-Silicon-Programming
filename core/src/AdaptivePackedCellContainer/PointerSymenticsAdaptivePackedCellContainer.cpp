            ...
            if (head_locality == PackedCellLocalityTypes::IDLE && tail_locality == PackedCellLocalityTypes::IDLE)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        meta16_t strl_tail = PackedCell64_t::MakeInCellMetaForMode_32t(CellMap::IN_CLOCKED_GENERIC_SPIKE, PackedCellOwnership::ADAPTIVE_PACKED_CELL_CONTAINER, PackedCellLocalityTypes::PUBLISHED, rel_mask_with_ptrflag, SubClassesOfMode32::LOW_OF_PAIRED_VERSIONED_CELL);
                        ...
                        meta16_t strl_head = PackedCell64_t::MakeInCellMetaForMode_32t(CellMap::IN_CLOCKED_GENERIC_SPIKE, PackedCellOwnership::ADAPTIVE_PACKED_CELL_CONTAINER, PackedCellLocalityTypes::PUBLISHED, rel_mask_with_ptrflag, SubClassesOfMode32::HIGH_OF_PAIRED_VERSIONED_CELL);
